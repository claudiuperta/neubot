...
'''
 Client-side `negotiate` and `collect` phases of the voip test.  Invokes code in
 voip_clnt.py for the `test` phase.
'''
...
class RawNegotiate(HttpClient):
    ...
    def handle_connection_made(self, stream):
        ...
        self.append_request(stream, 'GET', '/negotiate/voip', 'HTTP/1.1')
