# neubot/negotiate/server_voip.py
...
class NegotiateServerSkype(NegotiateServerModule):

    ''' Negotiator for Skype '''

    def __init__(self):
        ''' Initialize VoIP negotiator '''
    ...
    def unchoke(self, stream, request_body):
        ...
        if ident not in self.clients:
            ...
            logging.info('Returing authorization %s', ident)
...
NEGOTIATE_SERVER_SKYPE = NegotiateServerSkype()
